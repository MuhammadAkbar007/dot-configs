# Generated by Powerlevel10k configuration wizard on 2024-10-09 at 18:04 +05.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
	context					# username with hostname
    vcs                     # git status
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # Always display the hostname
  typeset -g POWERLEVEL9K_HOSTNAME_ALWAYS=true
  typeset -g POWERLEVEL9K_HOSTNAME_CONTENT_EXPANSION='%m'
